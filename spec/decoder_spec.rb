...
describe PDUTools::Decoder do
  ...
  context "Odd length of address in 7 bit alphabet" do
    let(:pdu) { "" }

    it do
      message_part = decoder.decode
      expect(message_part.address).to eq "AXA SK"
    end
  end
